...
const SSH_AGENT_CONSTRAIN_LIFETIME_S: &'static str = "SSH_AGENT_CONSTRAIN_LIFETIME";
const SSH_AGENT_CONSTRAIN_CONFIRM: u8 = 2;
const SSH_AGENT_CONSTRAIN_CONFIRM_S: &'static str = "SSH_AGENT_CONSTRAIN_CONFIRM";
const SSH_AGENT_CONSTRAIN_EXTENSION: u8 = 3;
const SSH_AGENT_CONSTRAIN_EXTENSION_S: &'static str = "SSH_AGENT_CONSTRAIN_EXTENSION";
